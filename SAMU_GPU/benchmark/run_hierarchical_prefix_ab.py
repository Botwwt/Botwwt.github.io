"""A/B the serial chunk prefix against an exact hierarchical prefix."""
...
def main():
    ...
    backends = ("fused_chunk16", "fused_hierarchical_chunk16")
    rows = []
    ...
    value = {
        ...
        "protocol": {
            "scope": "canonical RG-LRU preparation plus exact K=16 chunk scan",
            "comparison": "only the prefix over chunk summaries changes",
            "serial": "one Triton program per batch/width tile loops over C chunks",
            "hierarchical": "Hillis-Steele affine prefix, log2(C) stages and ping-pong summary buffers",
