...
export const lessons = [
  ...
  },
  {
    ...
    body: `
      ...
      <div><b>图 3 长度与规模轴</b><p>采用 Griffin 表 2 的 400M 与 1.3B 宽度、递推宽度和层数。两个规模都真实执行 2K、4K、8K 三种序列长度的完整 AdamW 步骤。</p></div></div>
  ...
  },
  {
    ...
    body: `
      <ol class="research-checklist">
        ...
        <li><b>结果完整：</b>训练同时报告 400M、1.3B 的绝对耗时、速度比与峰值显存；推理同时报告 B=16 延迟、空提示/4K 提示、共同批量搜索、完整轨迹吞吐和缓存字节。</li>
      </ol>
      `,
  },
];
